    ...
    try {
      ...
      recipes.value = [
        ...
        },
        {
          ...
          cost: '€€',
          description:
            'Mexikanische Tacos mit mariniertem Schweinefleisch und Ananas.',
        },
        {
          id: '9',
          ...
          cost: '€€',
          description:
            'Cremiges Pilzrisotto mit Parmesan und frischem Thymian.',
        },
        {
          id: '10',
          title: 'Pancakes',
        ...
        },
        {
          ...
          cost: '€€',
          description:
            'Japanische Nudelsuppe mit reichhaltiger Brühe und weichem Ei.',
        },
        {
          id: '13',
          title: 'Fish & Chips',
          imageUrl:
            'https://images.unsplash.com/photo-1551164634-0a19b52d3e68?w=400&h=300&fit=crop',
          duration: '30min',
          cost: '€€',
          description:
            'Knusprig panierter Fisch mit goldenen Pommes und Erbsenpüree.',
        },
        {
          id: '14',
          title: 'Falafel Bowl',
          imageUrl:
            'https://images.unsplash.com/photo-1547058881-aa0edd92aab3?w=400&h=300&fit=crop',
          duration: '25min',
          cost: '€',
          description:
            'Knusprige Falafel mit Hummus, Tabouleh und Tahini-Dressing.',
        },
        {
          id: '15',
          title: 'Wiener Schnitzel',
          imageUrl:
            'https://images.unsplash.com/photo-1599921841143-819065a55cc6?w=400&h=300&fit=crop',
          duration: '30min',
          cost: '€€',
          description:
            'Klassisches paniertes Kalbsschnitzel mit Zitrone und Kartoffelsalat.',
        },
        {
          id: '16',
          title: 'Pho Bo',
          ...
          cost: '€€',
          description:
            'Vietnamesische Rindfleischsuppe mit Reisnudeln und frischen Kräutern.',
        },
        {
          id: '17',
          ...
          cost: '€',
          description:
            'Klassische Pizza mit Tomatensoße, Mozzarella und frischem Basilikum.',
        },
        {
          id: '18',
          title: 'Bibimbap',
          ...
          cost: '€€',
          description:
            'Koreanische Reisschüssel mit Gemüse, Ei und scharfer Gochujang-Sauce.',
        },
        {
          id: '19',
          ...
          cost: '€',
          description:
            'Dünne französische Pfannkuchen mit Orangenbutter und Grand Marnier.',
        },
        {
          id: '20',
          ...
          cost: '€€',
          description:
            'Langsam gegartes Schweinefleisch mit BBQ-Sauce und Coleslaw.',
        },
      ];
    } finally {
