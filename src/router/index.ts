...
const routes = [
  ...
  { path: '/recipes/create', component: CreateRecipeView, meta: { titleKey: 'feature.createRecipe.title' } },
  { path: '/listall', component: AllRecipesPage, meta: { titleKey: 'feature.listAllRecipes.title' } }
